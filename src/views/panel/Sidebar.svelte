<script>
  import { panelDrawer, user } from "$services/store";
...
<div
  class="fixed transition-all z-[99999] non-printable
...
>
  <div class="w-[18rem] shadow-lg">
    ...
    <div class="overflow-y-auto h-[calc(100%-9.75rem)] px-4">
      ...
      <div class="rounded bg-neutral p-2 flex flex-col gap-1 mb-2">
        <h2 class="text-black text-bold border-b text-md py-1">Katalog</h2>

        <SideMenuButton
          icon={"bi bi-images"}
          title={"Giriş/Son Resimleri"}
          href={"/panel/catalogImages"}
        />
        <SideMenuButton
          icon={"bi bi-gear"}
          title={"Katalog Builder"}
          href={"/catalog"}
        />
        <SideMenuButton
